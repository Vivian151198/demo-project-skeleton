...
public class ShippingMethodComponent {
    ...
    private final By nextDayOptionSel = By.cssSelector("[value='Next Day Air__Shipping.FixedRate']");
    private final By secondDayOptionSel = By.cssSelector("[value='2nd Day Air__Shipping.FixedRate']");
